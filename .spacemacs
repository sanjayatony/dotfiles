...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; dotspacemacs-mode-line-unicode-symbol t
...
This function is called at the very end of Spacemacs startup, after layerconfiguration.
Put your configuration code here, except for variables that should be set
before packages are loaded."
  (setq org-todo-keywords '((sequence "TODO" "PROGRESS" "|" "DONE")))
  (setq org-todo-keyword-faces
        '(("TODO" . "#fbbf24") ("PROGRESS" . "#3b82f6") ("DONE" . "#86dc2f") ))
